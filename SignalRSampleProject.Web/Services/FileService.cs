...
public class FileService(AppDbContext context,HttpContextAccessor httpContextAccessor, UserManager<IdentityUser> userManager,Channel<(string,List<Product>)> channel)
{
